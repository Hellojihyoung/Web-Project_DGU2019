	...
	<div class = "container">
		...
		<div class = "col-lg-4">
			<div class= "jumbortron" style = "padding-top : 20px;">
				<form method ="post" action ="joinAction.jsp"> <!-- 로그인액션이라는 페이지로 로그인 정보를 보냄-->
					<h3 style="text-align : center;">Join Our Web-page</h3>
					<br><br>
					...
					<div class = "form-group">
						<input type = "text" class = "form-control" placeholder ="Phone Number" name ="userNumber" maxlength ="20">
					</div>
					<div class = "form-group" style = "text-align:center;">
						<div class = "btn-group" data-toggle="buttons">
							
							<label class="btn btn-primary active">
								<input type = "radio" name = "userDoctor" autocomplete="off" value ="의사" checked>Doctor
							</label>
							
							<label class="btn btn-primary">
								<input type = "radio" name = "userDoctor" autocomplete="off" value ="주인" checked>Family
							</label>
